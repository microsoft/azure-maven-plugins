...
public abstract class AbstractMojoBase extends AbstractAzureMojo {
    ...
    /**
     * Runtime version of the Spring cloud app, supported values are `Java 8`, `Java 11` and `Java 17`
     */
    @Getter
     ...
     *     <li>runtimeVersion: The runtime version for spring cloud app,  supported values are `Java 8`, `Java 11` and `Java 17`. </li>
