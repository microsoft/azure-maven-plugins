...
@PrepareForTest({AzureAuthHelper.class, AppInsightHelper.class, TelemetryClient.class, ConfigMojo.class, AbstractMojoBase.class, Azure.class,
    ServiceResourceInner.class, ProxyResource.class, SpringCloudClusterService.class, ConfigurationUpdater.class})
public class ConfigMojoTest {
    ...
    private void initMockPromptWrapper() throws IOException, InvalidConfigurationException, IllegalAccessException, Exception {
        final ConfigurationPrompter wrapper = new ConfigurationPrompter(mockEval, mockLog) {
        ...
        whenNew(ConfigurationPrompter.class).withAnyArguments().thenReturn(wrapper);
    }
}
