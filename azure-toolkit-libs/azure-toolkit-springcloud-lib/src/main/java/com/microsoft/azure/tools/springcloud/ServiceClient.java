...
public class ServiceClient {
    ...
    public ServiceClient(AzureTokenCredentials azureTokenCredentials, String subscriptionId, String userAgent) {
        this(azureTokenCredentials, subscriptionId, userAgent, LogLevel.NONE);
    }

    public ServiceClient(AzureTokenCredentials azureTokenCredentials, String subscriptionId, String userAgent, LogLevel logLevel) {
    ...
    public AppClient newSpringAppClient(String subscriptionId, String cluster, String app) {
        final AppClient.Builder builder = new AppClient.Builder();
    ...
    public AppClient newSpringAppClient(AppConfig configuration) {
