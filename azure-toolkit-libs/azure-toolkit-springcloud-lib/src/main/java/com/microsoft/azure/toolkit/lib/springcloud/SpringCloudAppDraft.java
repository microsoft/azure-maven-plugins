...
public class SpringCloudAppDraft extends SpringCloudApp implements AzResource.Draft<SpringCloudApp, SpringApp> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "springcloud.create_app.app", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "springcloud.update_app.app", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
