...
public class AppClient extends AbstractClientBase {
    ...
    @Nonnull
    public AppResourceInner createOrUpdateApp(final AppResourceInner app, final AppConfig configuration) {
        return Objects.isNull(app) ? createApp(configuration) : updateApp(app, configuration);
    }

    @Nonnull
    public AppResourceInner createApp(final AppConfig configuration) {
    ...
    @Nonnull
    public AppResourceInner updateApp(final AppResourceInner app, final AppConfig configuration) {
    ...
    public AppDeploymentClient getDeploymentClient(String deploymentName, final AppResourceInner app) {
        ...
        return new AppDeploymentClient(this, deploymentName);
    }

    public ResourceUploadDefinitionInner uploadArtifact(File artifact) throws AzureExecutionException {
        ...
        StorageUtils.uploadFileToStorage(artifact, resourceUploadDefinition.uploadUrl());
    ...
    public static AppResourceProperties mergeConfigurationIntoProperties(AppConfig configuration, AppResourceProperties properties) {
    ...
    private static boolean isEnablePersistentStorage(AppConfig configuration) {
