...
public class AzureHtmlMessagePatternTest {
    ...
    public void startWithNoSpace() {
        ...
        final String expectedResult = "<b>Azure: </b><a href='https://github.com/microsoft/azure-tools-for-java'>https://github.com/microsoft/azure-tools-for-java</a>";
    ...
    public void containsHref() {
        ...
        final String expectedResult = "<b>Azure: </b>refer to <a href='https://azure.github.io/azure-sdk/releases/latest/java.html'>Azure SDK Releases</a>";
        Assert.assertEquals(expectedResult, message.getContent());
    }
    ...
    public void containsMultiHref() {
        ...
        final AzureHtmlMessage message = new AzureHtmlMessage(IAzureMessage.Type.INFO, textStrContainsHref);
        final String expectedResult = "<b>Azure: </b>refer to <a href='https://azure.github.io/azure-sdk/releases/latest/java.html'>Azure SDK Releases</a> and <a href='https://github.com/microsoft/azure-tools-for-java'>https://github.com/microsoft/azure-tools-for-java </a>";
        Assert.assertEquals(expectedResult, message.getContent());
    }
}
