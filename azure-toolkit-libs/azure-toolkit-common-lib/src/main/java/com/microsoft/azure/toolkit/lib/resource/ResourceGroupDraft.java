...
public class ResourceGroupDraft extends ResourceGroup implements AzResource.Draft<ResourceGroup, com.azure.resourcemanager.resources.models.ResourceGroup> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "arm.create_group.rg", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "arm.update_group.rg", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
