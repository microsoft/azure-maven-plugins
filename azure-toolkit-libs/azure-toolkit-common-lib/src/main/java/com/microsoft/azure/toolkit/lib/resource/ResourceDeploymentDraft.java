...
public class ResourceDeploymentDraft extends ResourceDeployment
    ...
    @Override
    @AzureOperation(name = "azure/arm.create_deployment.deployment", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @SneakyThrows({IOException.class})
    @Override
    @AzureOperation(name = "azure/arm.update_deployment.deployment", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
