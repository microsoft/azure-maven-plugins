...
public class RedisCacheDraft extends RedisCache implements AzResource.Draft<RedisCache, com.azure.resourcemanager.redis.models.RedisCache> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "redis.create_redis.redis", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "redis.update_redis.redis", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
