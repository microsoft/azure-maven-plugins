...
public class PostgreSqlFirewallRuleDraft extends PostgreSqlFirewallRule implements AzResource.Draft<PostgreSqlFirewallRule, FirewallRule> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/postgre.create_firewall_rule.rule", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/postgre.update_firewall_rule.rule", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
