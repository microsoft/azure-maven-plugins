...
public class PostgreSqlServerDraft extends PostgreSqlServer implements AzResource.Draft<PostgreSqlServer, Server> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "postgre.create_server.server", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "postgre.update_server.server", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
