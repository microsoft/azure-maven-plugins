...
public class KubernetesClusterDraft extends KubernetesCluster implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/kubernetes.create_cluster.cluster", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/kubernetes.update_cluster.cluster", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
