...
public class ApplicationInsightDraft extends ApplicationInsight implements AzResource.Draft<ApplicationInsight, ApplicationInsightsComponent> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "ai.create_ai.ai", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "ai.update_ai.ai", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
