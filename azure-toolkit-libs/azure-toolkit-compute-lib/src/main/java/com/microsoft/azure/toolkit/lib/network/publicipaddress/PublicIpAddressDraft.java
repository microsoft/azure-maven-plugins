...
public class PublicIpAddressDraft extends PublicIpAddress implements AzResource.Draft<PublicIpAddress, com.azure.resourcemanager.network.models.PublicIpAddress> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/vm.create_public_ip_address.address", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/vm.update_public_ip_address.address", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
