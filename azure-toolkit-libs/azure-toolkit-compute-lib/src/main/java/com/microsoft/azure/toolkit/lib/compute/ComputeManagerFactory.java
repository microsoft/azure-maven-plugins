...
public class ComputeManagerFactory {
    private ComputeManagerFactory() {
    }

    @Cacheable(cacheName = "ComputeManager", key = "$subscriptionId")
    public static ComputeManager create(String subscriptionId) {
