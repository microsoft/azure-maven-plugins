...
public class VirtualMachineDraft extends VirtualMachine implements AzResource.Draft<VirtualMachine, com.azure.resourcemanager.compute.models.VirtualMachine> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "vm.create_vm.vm", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "vm.update_vm.vm", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
