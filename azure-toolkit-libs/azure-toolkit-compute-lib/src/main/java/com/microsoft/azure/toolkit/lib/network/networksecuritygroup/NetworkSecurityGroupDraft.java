...
public class NetworkSecurityGroupDraft extends NetworkSecurityGroup implements AzResource.Draft<NetworkSecurityGroup, com.azure.resourcemanager.network.models.NetworkSecurityGroup> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "vm.create_nsg_in_azure.nsg", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "vm.update_nsg_in_azure.nsg", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
