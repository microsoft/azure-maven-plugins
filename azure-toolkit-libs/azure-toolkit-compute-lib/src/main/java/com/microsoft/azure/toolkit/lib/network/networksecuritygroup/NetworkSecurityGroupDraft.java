...
public class NetworkSecurityGroupDraft extends NetworkSecurityGroup implements AzResource.Draft<NetworkSecurityGroup, com.azure.resourcemanager.network.models.NetworkSecurityGroup> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/vm.create_nsg.nsg", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/vm.update_nsg.nsg", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
