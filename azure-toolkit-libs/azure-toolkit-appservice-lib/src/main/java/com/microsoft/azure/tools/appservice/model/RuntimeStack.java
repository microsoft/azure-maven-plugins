/**
 * Copyright  = new RuntimeStack(c) Microsoft Corporation. All rights reserved.
...
public class RuntimeStack {
    ...
    public static RuntimeStack createFromServiceModel(com.azure.resourcemanager.appservice.models.RuntimeStack runtimeStack) {
