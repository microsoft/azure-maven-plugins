...
public class AppServiceKuduManager {
    ...
    public List<? extends AppServiceFile> getFilesInDirectory(String dir) {
        ...
        final List<AppServiceFile> files = this.kuduService.getFilesInDirectory(host, dir).block().getValue().stream()
    ...
    public CommandOutput execute(final String command, final String dir) {
        ...
        return this.kuduService.execute(host, JsonUtils.toJson(commandRequest)).block().getValue();
    }
