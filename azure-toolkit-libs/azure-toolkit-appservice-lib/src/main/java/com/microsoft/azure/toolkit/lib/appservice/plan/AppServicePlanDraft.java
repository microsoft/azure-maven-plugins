...
public class AppServicePlanDraft extends AppServicePlan implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "appservice.create_plan.plan", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "appservice.update_plan.plan", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
