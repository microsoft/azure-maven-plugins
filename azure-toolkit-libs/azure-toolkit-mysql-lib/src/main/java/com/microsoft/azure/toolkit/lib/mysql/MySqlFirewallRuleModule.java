...
public class MySqlFirewallRuleModule extends AbstractAzResourceModule<MySqlFirewallRule, MySqlServer, FirewallRule> {
    ...
    @Nullable
    @Override
    @AzureOperation(name = "azure/mysql.load_firewall_rule.rule", params = {"name"})
    ...
    @Override
    @AzureOperation(name = "azure/mysql.delete_firewall_rule.rule", params = {"nameFromResourceId(id)"})
