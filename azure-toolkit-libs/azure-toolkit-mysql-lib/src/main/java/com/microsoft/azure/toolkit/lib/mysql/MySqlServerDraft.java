...
public class MySqlServerDraft extends MySqlServer implements AzResource.Draft<MySqlServer, Server> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "mysql.create_server.server", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "mysql.update_server.server", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
