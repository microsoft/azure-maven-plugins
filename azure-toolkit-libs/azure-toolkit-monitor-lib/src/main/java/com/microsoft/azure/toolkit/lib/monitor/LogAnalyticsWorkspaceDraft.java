...
public class LogAnalyticsWorkspaceDraft extends LogAnalyticsWorkspace implements AzResource.Draft<LogAnalyticsWorkspace, Workspace> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/monitor.create_log_analytics_workspace.workspace", params = {"this.getName()"})
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/monitor.update_log_analytics_workspace.workspace", params = {"this.getName()"})
