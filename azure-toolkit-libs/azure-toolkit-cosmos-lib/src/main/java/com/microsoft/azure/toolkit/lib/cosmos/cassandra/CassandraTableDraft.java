...
public class CassandraTableDraft extends CassandraTable implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.create_cassandra_table.table", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.update_cassandra_table.table", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
