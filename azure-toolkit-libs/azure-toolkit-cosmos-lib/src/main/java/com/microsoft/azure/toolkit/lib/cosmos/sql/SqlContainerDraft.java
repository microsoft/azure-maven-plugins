...
public class SqlContainerDraft extends SqlContainer implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.create_sql_container_in_azure.container", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.update_sql_container_in_azure.container", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
