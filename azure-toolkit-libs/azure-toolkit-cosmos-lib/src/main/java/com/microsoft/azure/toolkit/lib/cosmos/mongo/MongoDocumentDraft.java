...
public class MongoDocumentDraft extends MongoDocument implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.create_mongo_document_in_azure.document", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.update_mongo_document_in_azure.document", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
