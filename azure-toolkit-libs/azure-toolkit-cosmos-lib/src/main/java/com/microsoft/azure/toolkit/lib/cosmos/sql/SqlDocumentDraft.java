...
public class SqlDocumentDraft extends SqlDocument implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.create_sql_document.document", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.update_sql_document.document", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
