...
public class MongoCollectionDraft extends MongoCollection implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/cosmos.create_mongo_collection.collection", params = {"this.getName()"})
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/cosmos.update_mongo_collection.collection", params = {"this.getName()"})
