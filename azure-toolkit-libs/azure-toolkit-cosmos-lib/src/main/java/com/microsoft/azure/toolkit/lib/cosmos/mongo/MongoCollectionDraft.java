...
public class MongoCollectionDraft extends MongoCollection implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.create_mongo_collection.collection", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.update_mongo_collection.collection", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
