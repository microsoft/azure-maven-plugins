...
public class MongoDatabaseDraft extends MongoDatabase implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/cosmos.create_mongo_database.database", params = {"this.getName()"})
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/cosmos.update_mongo_database.database", params = {"this.getName()"})
