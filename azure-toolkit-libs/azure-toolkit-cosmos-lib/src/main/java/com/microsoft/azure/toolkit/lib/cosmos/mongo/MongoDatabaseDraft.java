...
public class MongoDatabaseDraft extends MongoDatabase implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.create_mongo_database.database", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.update_mongo_database.database", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
