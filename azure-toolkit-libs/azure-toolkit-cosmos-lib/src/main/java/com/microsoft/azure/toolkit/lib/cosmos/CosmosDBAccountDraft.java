...
public class CosmosDBAccountDraft extends CosmosDBAccount implements
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.create_account_in_azure.account", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "cosmos.update_account_in_azure.account", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
