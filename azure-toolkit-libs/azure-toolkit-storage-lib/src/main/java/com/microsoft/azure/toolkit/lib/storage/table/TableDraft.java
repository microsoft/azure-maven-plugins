...
public class TableDraft extends Table implements AzResource.Draft<Table, TableClient> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "storage.create_table.table", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "storage.update_table.table", params = {"this.getName()"}, type = AzureOperation.Type.SERVICE)
