...
public class Redundancy implements ExpandableParameter {
    ...
    public static final Redundancy PREMIUM_ZRS = new Redundancy(Performance.PREMIUM, "Premium_ZRS", "Zone-Redundant"); // sdk not

    private static final List<Redundancy> values = new ImmutableList.Builder<Redundancy>().add(STANDARD_ZRS, STANDARD_LRS, STANDARD_GRS, STANDARD_RAGRS, PREMIUM_LRS, PREMIUM_ZRS).build();
