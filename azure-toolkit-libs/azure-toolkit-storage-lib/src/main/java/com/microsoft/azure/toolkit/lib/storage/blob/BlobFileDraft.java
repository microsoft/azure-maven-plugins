...
public class BlobFileDraft extends BlobFile implements StorageFile.Draft<BlobFile, BlobItem> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "storage.create_blob.blob", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "storage.update_blob.blob", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
