...
public class QueueDraft extends Queue implements AzResource.Draft<Queue, QueueClient> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "storage.create_queue_in_azure.queue", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "storage.update_queue_in_azure.queue", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
