...
public class QueueDraft extends Queue implements AzResource.Draft<Queue, QueueClient> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/storage.create_queue.queue", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/storage.update_queue.queue", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
