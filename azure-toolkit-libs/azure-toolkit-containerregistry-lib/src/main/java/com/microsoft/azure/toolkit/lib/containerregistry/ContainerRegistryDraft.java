...
public class ContainerRegistryDraft extends ContainerRegistry implements AzResource.Draft<ContainerRegistry, Registry> {
    ...
    @Override
    @Nonnull
    @AzureOperation(name = "container.create_registry_in_azure.registry", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Override
    @Nonnull
    @AzureOperation(name = "container.update_registry_in_azure.registry", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
