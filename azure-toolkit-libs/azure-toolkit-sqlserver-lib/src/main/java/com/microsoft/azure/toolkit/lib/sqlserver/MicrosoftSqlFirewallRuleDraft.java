...
public class MicrosoftSqlFirewallRuleDraft extends MicrosoftSqlFirewallRule implements AzResource.Draft<MicrosoftSqlFirewallRule, SqlFirewallRule> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "sqlserver.create_firewall_rule.rule", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "sqlserver.update_firewall_rule.rule", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
