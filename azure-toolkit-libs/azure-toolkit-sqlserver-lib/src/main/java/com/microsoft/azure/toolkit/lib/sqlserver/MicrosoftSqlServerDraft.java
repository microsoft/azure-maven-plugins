...
public class MicrosoftSqlServerDraft extends MicrosoftSqlServer implements AzResource.Draft<MicrosoftSqlServer, SqlServer> {
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/sqlserver.create_server.server", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
    ...
    @Nonnull
    @Override
    @AzureOperation(name = "azure/sqlserver.update_server.server", params = {"this.getName()"}, type = AzureOperation.Type.REQUEST)
