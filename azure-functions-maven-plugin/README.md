...
`<localDebugConfig>` | false | The config string of debug options, you may visit [here](https://docs.oracle.com/javase/7/docs/technotes/guides/jpda/conninv.html) for more infos. The default value is `transport=dt_socket,server=y,suspend=n,address=5005`;
