...
public class PackageMojo extends AbstractFunctionMojo {
    ...
    public static final String SAVING_HOST_JSON = "Step 4 of 8: Copying/Generating host.json";
    public static final String SAVING_LOCAL_SETTINGS_JSON = "Step 5 of 8: Copying/Generating local.settings.json";
